...
class AdminController extends Controller
{
    ...
    {
        $students = User::select('*')->join('grades', 'grades.id', '=', 'users.grade_id')->orderBy('users.created_at', 'DESC')->get();
//        $students = User::orderBy('created_at', 'DESC')->get();
    ...
    public function viewStudentDetail($nim)
    {
        $student = User::where('nim', $nim)->first();
        $achievements = Achievement::select('*')->join('users', 'users.nim', '=', 'achievements.nim')
    ...
    public function viewGradeClasification() {
        $grades = Grade::all();
        return view('admin.grade-clasification.grade-clasification', [
            'grades' => $grades,
        ]);
    }
    ...
    public function viewGradeClasificationDetail($id) {
        return view('admin.grade-clasification.grade-clasification-detail');
    }
    ...
    {
        $grades = Grade::all();
        return view('admin.users.student.create-student', compact('grades'));
    }
    ...
    public function createMessage($nim) {
        $student = User::where('nim', $nim)->first();
        return view('admin.messages.create-message', [
            'student' => $student,
        ]);
    }
