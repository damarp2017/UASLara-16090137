                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name" required type="text" id="name" class="form-control"
                                               placeholder="Enter Name" minlength="5" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="nim">NIM</label>
                                        <input name="nim" required type="text" id="nim" class="form-control"
                                               placeholder="Enter NIM" maxlength="8">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="grade_id">
                                            @foreach($grades as $grade)
                                                <option value="{{ $grade->id }}">{{ $grade->grade_name }}</option>
                                            @endforeach
                                        </select>
                                        <small class="form-control-feedback"> Select class</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="email" required type="email" id="email" class="form-control"
                                               placeholder="Example@website.com" maxlength="50">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="phone" required type="text" id="phone" class="form-control"
                                               placeholder="Enter phone" maxlength="15">
                                    </div>
                                </div>
                            </div>
                        </div>
